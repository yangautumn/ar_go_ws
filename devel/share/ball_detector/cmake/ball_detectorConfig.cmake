...
if("TRUE" STREQUAL "TRUE")
  set(ball_detector_SOURCE_PREFIX /home/ao/self-driving-car/src/ball_detector)
  set(ball_detector_DEVEL_PREFIX /home/ao/self-driving-car/devel)
  ...
  set(ball_detector_INSTALL_PREFIX /home/ao/self-driving-car/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ball_detector' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ao <ao@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ball_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ao/self-driving-car/src/ball_detector/${idir}'.  Ask the maintainer 'ao <ao@todo.todo>' to fix it.")
    endif()
...
set(ball_detector_EXPORTED_TARGETS "")
