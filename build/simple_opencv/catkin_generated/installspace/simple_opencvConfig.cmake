...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_opencv' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ao/self-driving-car/install/${idir}'.  Ask the maintainer 'smcguire <stephen.mcguire@coloado.edu>' to fix it.")
    endif()
